		...
		<table class="form-table"><tbody>
			<tr>
				...
				<td>
					...
					<p><small>Number of days' worth of upcoming events to include in feed. Default is <b>7</b>.</small></p>
				</td>
			</tr>
			<tr>
				<th>Max Events</th>
				<td>
					...
					<p><small>Maximum number of events to include in feed. Should be more than the maximum number of events you are likely to have in the span of <b>Days Out</b> above. Default is <b>100</b>.</small></p>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<p><small>By default, this plugin only adds featured images to the Events RSS feed. By checking this box, featured images will be added to the feeds for all post types on your site. (Your theme must support <a href="https://codex.wordpress.org/Post_Thumbnails" target="_blank">featured images</a>.)</small></p>
				</td>
			</tr>
			<tr>
				<th>Venue Links</th>
